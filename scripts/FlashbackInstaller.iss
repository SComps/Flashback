...
Name: "{group}\Tools\Flashback Console"; Filename: "{app}\Flashback.Config.Console.exe"; WorkingDir: "{app}"; IconFilename: "{app}\Assets\printer.ico"; Comment: "Flashback Console Configuration"
Name: "{group}\Tools\Flashback WPF"; Filename: "{app}\Flashback.Config.WPF.exe"; WorkingDir: "{app}"; IconFilename: "{app}\Assets\printer.ico"; Comment: "Flashback WPF Configuration"
Name: "{group}\Tools\Flashback WinUI"; Filename: "{app}\Flashback.Config.WinUI.exe"; WorkingDir: "{app}"; IconFilename: "{app}\Assets\printer.ico"; Comment: "Flashback WinUI Configuration"
...
Name: "{group}\Flashback Spooler"; Filename :"{app}\Flashback.Spooler.exe"; WorkingDir: "{app}"; IconFilename: "{app}\Assets\printer.ico"; Comment: "Flashback Raw Printer spooler"
